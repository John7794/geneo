...
js = js.replace(/if \(this\.engine\.db\.birth\) \{\s*this\.engine\.db\.birth\.forEach\(b => countPlace\(b\[COLUMNS\.birth\?\.placeId \|\| "place_id"\], "народження"\)\);\s*\}/, 
...
js = js.replace(/if \(this\.engine\.db\.death\) \{\s*this\.engine\.db\.death\.forEach\(d => countPlace\(d\[COLUMNS\.death\?\.placeId \|\| "place_id"\], "смерть"\)\);\s*\}/, 
...
js = js.replace(/if \(this\.engine\.db\.marriage\) \{\s*this\.engine\.db\.marriage\.forEach\(m => countPlace\(m\[COLUMNS\.marriage\?\.placeId \|\| "place_id"\], "шлюб"\)\);\s*\}/, 
...
js = js.replace(/if \(this\.engine\.db\.baptism\) \{\s*this\.engine\.db\.baptism\.forEach\(m => countPlace\(m\[COLUMNS\.baptism\?\.placeId \|\| "place_id"\], "хрещення"\)\);\s*\}/, 
...
js = js.replace(/if \(this\.engine\.db\.funeral\) \{\s*this\.engine\.db\.funeral\.forEach\(m => countPlace\(m\[COLUMNS\.funeral\?\.placeId \|\| "place_id"\], "поховання"\)\);\s*\}/, 
