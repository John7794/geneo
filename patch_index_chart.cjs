...
html = html.replace(
    'id="analytics-timeline-chart" style="display: none; width: 100%; overflow-x: auto; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border); margin-top: 12px; padding: 16px;"',
